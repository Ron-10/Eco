      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center'>
          ...
          <p className='mt-4 max-w-2xl mx-auto text-xl text-gray-500'>
            UrjaTech empowers individuals to reduce their carbon footprint
            through gamified rewards, making sustainability accessible and
        ...
        <div className='mt-16'>
          <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4'>
            {[
              ...
              <div
                key={index}
                className='bg-white rounded-lg shadow px-6 py-8 text-center'
              >
            ...
            <div className='px-6 py-8 sm:p-10'>
              ...
              <div className='prose prose-green max-w-none'>
                <p className='text-gray-500'>
                  Founded in 2025, UrjaTech emerged from a simple idea: make
                  environmental sustainability rewarding and accessible to
                  everyone. We believe that small actions, when multiplied by
                  millions of people, can transform the world.
                </p>
                <p className='text-gray-500 mt-4'>
                  Our platform combines cutting-edge technology with behavioral
                  science to help individuals and communities track, reduce, and
                  offset their carbon footprint while earning rewards for their
                  positive impact.
                </p>
              </div>
            </div>
        ...
        <div className='mt-16'>
          <div className='bg-green-50 rounded-lg shadow-sm px-6 py-8 sm:p-10'>
            ...
            <p className='text-center text-gray-600 max-w-2xl mx-auto'>
              Want to learn more about how UrjaTech can help your community
              reduce its carbon footprint? We'd love to hear from you.
            </p>
