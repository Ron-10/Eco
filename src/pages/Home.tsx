            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  A gamified platform to reduce your carbon footprint and unlock real-world rewards. Join us in building a sustainable future.
                </p>
              ...
              {[
                {
                  ...
                  description: 'Monitor your electricity consumption and see your impact in real-time.',
                  icon: Zap,
                },
                {
                  title: 'Earn Green Points',
                  description: 'Get rewarded for every sustainable action you take.',
                  icon: TreePine,
                },
                {
                  title: 'Reduce Emissions',
                  description: 'Track and reduce your carbon footprint with our smart calculator.',
                  icon: Car,
                },
              ].map((feature) => (
